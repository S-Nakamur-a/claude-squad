...
var defaultMenuOptions = []keys.KeyName{keys.KeyNew, keys.KeyPrompt, keys.KeyLocalBranch, keys.KeyRemoteBranch, keys.KeyHelp, keys.KeyQuit}
...
func (m *Menu) addInstanceOptions() {
	...
	options := []keys.KeyName{keys.KeyNew, keys.KeyLocalBranch, keys.KeyRemoteBranch, keys.KeyKill}
